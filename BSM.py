...
with st.sidebar:
    ...
    min_vol = col1.slider("Min Volatility (%)", 0.00, 1000.00, float(st.session_state.volatility) * 0.67, step=0.1)
    max_vol = col2.slider("Max Volatility (%)", 0.00, 1000.00, float(st.session_state.volatility) * 1.5, step=0.1)
