...
with st.sidebar:
    ...
    min_vol = col1.slider("Min Historical Volatility (%)", 0.00, 200.00, float(st.session_state.volatility) * 0.67, step=0.1)
    max_vol = col2.slider("Max Historical Volatility (%)", 0.00, 200.00, float(st.session_state.volatility) * 1.5, step=0.1)
